...
echo "$(json_ccp $ORG $P0PORT $CAPORT $PEERPEM $CAPEM $PEERPEM1 $P1PORT)" > ./consortium/crypto-config/peerOrganizations/bdbank/connection-bdbank.json
echo "$(yaml_ccp $ORG $P0PORT $CAPORT $PEERPEM $CAPEM $PEERPEM1 $P1PORT)" > ./consortium/crypto-config/peerOrganizations/bdbank/connection-bdbank.yaml
...
echo "$(json_ccp $ORG $P0PORT $CAPORT $PEERPEM $CAPEM $PEERPEM1 $P1PORT)" > ./consortium/crypto-config/peerOrganizations/abbank/connection-abbank.json
echo "$(yaml_ccp $ORG $P0PORT $CAPORT $PEERPEM $CAPEM $PEERPEM1 $P1PORT)" > ./consortium/crypto-config/peerOrganizations/abbank/connection-abbank.yaml
...
echo "$(json_ccp $ORG $P0PORT $CAPORT $PEERPEM $CAPEM $PEERPEM1 $P1PORT)" > ./consortium/crypto-config/peerOrganizations/dbbank/connection-dbbank.json
echo "$(yaml_ccp $ORG $P0PORT $CAPORT $PEERPEM $CAPEM $PEERPEM1 $P1PORT)" > ./consortium/crypto-config/peerOrganizations/dbbank/connection-dbbank.yaml
...
echo "$(json_ccp $ORG $P0PORT $CAPORT $PEERPEM $CAPEM $PEERPEM1 $P1PORT)" > ./consortium/crypto-config/peerOrganizations/islamibank/connection-islamibank.json
echo "$(yaml_ccp $ORG $P0PORT $CAPORT $PEERPEM $CAPEM $PEERPEM1 $P1PORT)" > ./consortium/crypto-config/peerOrganizations/islamibank/connection-islamibank.yaml
...
echo "$(json_ccp $ORG $P0PORT $CAPORT $PEERPEM $CAPEM $PEERPEM1 $P1PORT)" > ./consortium/crypto-config/peerOrganizations/krishibank/connection-krishibank.json
echo "$(yaml_ccp $ORG $P0PORT $CAPORT $PEERPEM $CAPEM $PEERPEM1 $P1PORT)" > ./consortium/crypto-config/peerOrganizations/krishibank/connection-krishibank.yaml
